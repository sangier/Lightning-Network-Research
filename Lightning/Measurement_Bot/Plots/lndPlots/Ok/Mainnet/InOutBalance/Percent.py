...
df2_midOut=data[(abs(data["Balance"])<2*data["Capacity"]/100) & (data["Channel_directionPeer1"]==1) & (data["Balance"]!=0)]
print(len(df2_midOut))

df2_midIn=data[(abs(data["Balance"])<2*data["Capacity"]/100) & (data["Channel_directionPeer1"]==0) & (data["Balance"]!=0)]
print(len(df2_midIn))

sum1=len(df2_midOut)+len(df2_midIn)

df2_VarOut=data[(abs(data["Balance"])>2*data["Capacity"]/100) & (data["Channel_directionPeer1"]==1) & (data["Balance"]!=0)]
print(len(df2_VarOut))

df2_VarIn=data[(abs(data["Balance"])>2*data["Capacity"]/100) & (data["Channel_directionPeer1"]==0) & (data["Balance"]!=0)]
print(len(df2_VarIn))

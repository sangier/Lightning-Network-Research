...
df2_outOk=data[(data["Balance"]==0) & (data["Channel_directionPeer1"]==0)]
print(len(df2_outOk))

df2_inOk=data[(data["Balance"]==0) & (data["Channel_directionPeer1"]==1)]
print(len(df2_inOk))

sum0=len(df2_outOk)+len(df2_inOk)

df2_midOut=data[(abs(data["Balance"])<2*data["Capacity"]/100) & (data["Channel_directionPeer1"]==0) & (data["Balance"]!=0)]
print(len(df2_midOut))

df2_midIn=data[(abs(data["Balance"])<2*data["Capacity"]/100) & (data["Channel_directionPeer1"]==1) & (data["Balance"]!=0)]
print(len(df2_midIn))

sum1=len(df2_midOut)+len(df2_midIn)

df2_VarOut=data[(abs(data["Balance"])>2*data["Capacity"]/100) & (data["Channel_directionPeer1"]==0) & (data["Balance"]!=0)]
print(len(df2_VarOut))

df2_VarIn=data[(abs(data["Balance"])>2*data["Capacity"]/100) & (data["Channel_directionPeer1"]==1) & (data["Balance"]!=0)]
print(len(df2_VarIn))

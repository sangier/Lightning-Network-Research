...
df = pd.read_json("TestnetDataMod.json")
print(df)
...
df3=df2[df1.EstimatedCapacity!=-10] 
#df3=df6[df2.Channel_direction==0]
df3.reset_index(drop=True,inplace=True)


df4=df3.Capacity/df3.Capacity 
df5=df3.EstimatedCapacity/df3.Capacity
...
ax.set_title("InOut Channels Testnet ")
#ax.set_xticks(df.index)

fig = ax.get_figure()
fig.savefig('Testnet_PHistInOut.png',bbox_inches='tight')

...
ConnectO=""
route={}
payment_hashList = ['3','5','a','b','9','1','5','e','3','b','9','d','4','e','3','0','d','e','1','a','1','2','6','3','7','f','e','4','9','d','3','1','2','5','e','c','0','5','6','0','b','2','b','9','a','f','5','d','1','b','4','c','d','f','3','8','8','4','e','8','7','5','1','2']
...
def Query_Select_Routes(LambdaT):
    ...
    if(error!="" or output==""):
        testFail=1
        print("Capacity Test failed lambda= "+str(LambdaT))
        return (testFail)
    else:			
...
def Main():
    ...
    with open('data_test.json') as f:
        Channel_Data1=json.loads(f.read())
    num_chan=(len(Channel_Data1['channels']))
    p=0;
    print(p,num_chan)
    ...
    while (p<num_chan):
        ...
        if p==num_chan:
            ...
            for i in range(p,num_chan):
                print(i)
                if int(Channel_Data["channels"][p]["real_capacity"])==-1:
    ...
    print("Peer Measurement successfully ended in :"+str(end-start)+" seconds!!")

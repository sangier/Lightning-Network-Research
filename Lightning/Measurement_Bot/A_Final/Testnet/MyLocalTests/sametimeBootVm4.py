...
def Main():
    ...
    peerList=[]
    peerList_ip=[]
	peerList.append("02d6d16fec1124470803e6472b7b85fb650909a3697fdfb5cb27e12ae7807f8ff8")
    peerList_ip.append("02d6d16fec1124470803e6472b7b85fb650909a3697fdfb5cb27e12ae7807f8ff8@163.117.166.53:9835")
    j=0
    for i in range(0,len(peerList)):
        address_only_pub=peerList[0][i]
        address=peerList_ip[0][i]
        cmd_net="lncli -network=testnet describegraph >mainnet_graph.json"
        c = subprocess.Popen([cmd_net],shell=True)
        c.communicate()
        channelExist=0

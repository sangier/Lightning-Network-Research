...
with open('dataFilteredPeer3.json',encoding='utf-8') as f:
    data=json.loads(f.read())

if os.path.exists("ChannelsLifePeer3.json"):
    print("Opening Existing Data File")
    with open('ChannelsLifePeer3.json') as f:
...
k=8
for i in range(8,len(data['channels'])):
    ...
    with open('ChannelsLifePeer3.json', 'w') as outfile:  

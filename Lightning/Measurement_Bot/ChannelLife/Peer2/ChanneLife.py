...
with open('dataFilteredPeer2.json',encoding='utf-8') as f:
    data=json.loads(f.read())

if os.path.exists("ChannelsLifePeer2.json"):
    print("Opening Existing Data File")
    with open('ChannelsLifePeer2.json') as f:
...
for i in range(0,len(data['channels'])):
    ...
    with open('ChannelsLifePeer2.json', 'w') as outfile:  
